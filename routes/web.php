...
Route::get('/test-mail', function () {
    ...
    try {
        ...
        Mail::raw('Test email from Laravel SMTP Gmail', function ($message) {

            $message->to('binabbuu@gmail.com')

                    ->subject('Test Email');

        });

        return 'Email imetumwa!';
...
Route::post('/test_post', [homeController::class, 'test_post']);
...
Route::get('/profolio', [ProfolioController::class, 'profolio_page']);
